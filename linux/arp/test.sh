...
function test_arp_ignore_0 {
    reset
    vagrant ssh client -- ping 10.74.68.58 -c 1 || fail "It should be no problem when arp_ignore=0"
}
...
function test_arp_ignore_1 {
    ...
    if vagrant ssh client -- ping 10.74.68.58 -c 1 -W 3; then
...
function test_arp_announce_0 {
    ...
    # Request who-has 10.74.68.58 tell 172.168.1.2
    vagrant ssh client -- ping -I 172.168.1.2 10.74.68.58 -c 1 -W 3 || fail "It should be ok"
}
...
function test_arp_announce_2 {
    ...
    # Request who-has 10.74.68.58 tell 10.74.68.10
    vagrant ssh client -- ping -I 172.168.1.2 10.74.68.58 -c 1 -W 3 || fail "It should be ok"
}
